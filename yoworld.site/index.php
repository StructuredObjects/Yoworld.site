...
$__userip = $_SERVER['HTTP_CF_CONNECTING_IP'];
$gang = new Utils();
$gang->log_visitor($__userip);
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <p style="padding-left: 20px;">This website is still under development!</p>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Quick Tool</h6>
